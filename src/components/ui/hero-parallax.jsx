...
export const HeroParallax = ({
  ...
  const translateY = useSpring(useTransform(scrollYProgress, [0, 0.2], [-600, 200]), springConfig);
  return (
    (<div
      ref={ref}
      ...
      <motion.div
        ...
        className="">
        <motion.div className="flex flex-row-reverse space-x-reverse space-x-20 mb-20 mt-28">
